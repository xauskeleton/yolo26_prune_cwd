...
1. **Moi layer** co than so `a` (learnable) dieu khien ti le channels giu lai
2. **Taylor importance**: tinh dong gop cua tongue channel toi loss = `(mask * grad)^2`
...
2. Tinh importance score cho tongue channel (method-specific)
