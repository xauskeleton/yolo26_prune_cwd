...
class Model(torch.nn.Module):
    ...
    def train(
        ...
        **kwargs: Any,
        ...
        dms_decay_ratio = args.pop("dms_decay_ratio", 1)
        dms_grad_scale = args.pop("dms_grad_scale", -1.0)
        ...
        if args.get("resume"):
            ...
            if isinstance(_ckpt_path, (str, Path)) and Path(_ckpt_path).exists():
                ...
                if _saved:
                    ...
                    if "dms_grad_scale" not in kwargs:
                        dms_grad_scale = _saved.get("dms_grad_scale", dms_grad_scale)
        ...
        self.trainer.dms_grad_scale = dms_grad_scale
        self.trainer.kd = kd
