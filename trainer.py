                    ...
                    if getattr(self, 'cwd_enabled', False):
                        ...
                        if epoch >= cwd_warmup:
                            ...
                            if kd_method == "cwd":
                                ...
                                from kd_losses import compute_response_kd_loss
                                ...
                                from kd_losses import compute_fitnets_loss
                                ...
                                from kd_losses import compute_mgd_loss
